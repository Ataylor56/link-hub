...
export default function LinkCards() {
    return (
        <div className="pt-5 space-y-2.5 overscroll-none">
            <div className={"flex flex-row bg-gray-100 max-w-screen-sm mx-auto p-2 rounded-xl shadow-md overflow-hidden md:max-w-2xl hover:bg-blue-900 hover:text-white"}>
